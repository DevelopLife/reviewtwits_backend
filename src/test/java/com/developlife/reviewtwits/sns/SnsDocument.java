...
public class SnsDocument {
    ...
    public static final Snippet userIdAndPageSizeRequestField = requestParameters(
            parameterWithName("size").attributes(required()).description("페이지 사이즈"),
            parameterWithName("userId").attributes(required()).description("뒤에 요청받을 유저 아이디").optional()
    );
